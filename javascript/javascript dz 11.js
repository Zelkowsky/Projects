...
alert(`${logIn === "оладьи" && pass === "оладьи1" ? "Вы успешно вошли в систему" : "Неверный логин или пароль"}`);
alert(`${logIn === "оладьи" || pass === "оладьи2" ? "Вы успешно вошли в систему" : "Неверный логин или пароль"}`);
